...
export function TicketCard({ ticket, onClick }: TicketCardProps) {
  ...
  return (
    <button
      ...
      className="flex flex-col w-full px-4 py-3 border-none border-b border-b-border-subtle rounded-none bg-bg-surface cursor-pointer transition-[background] duration-150 text-left hover:bg-bg-subtle"
    >
