    ...
    <section className="py-10 pb-20 bg-[var(--mk-bg)] max-[768px]:py-6 max-[768px]:pb-14">
      <div className={MK_CONTAINER}>
        ...
        <div className="text-center max-w-[720px] mx-auto mb-12 mk-reveal max-[768px]:mb-8">
          ...
          <h2 className="text-[clamp(28px,3.4vw,44px)] mb-[14px] font-[family-name:var(--mk-font-display)] font-bold tracking-[-0.035em] leading-[1.05]">
            Toutes vos conversations en un seul endroit
          </h2>
          <p className="text-[var(--mk-text-muted)] text-base m-0">
            Répondez, supervisez, formez votre agent — depuis une interface unique et claire.
          </p>
        </div>
          ...
          <div className="mk-mockup relative bg-[var(--mk-surface)] border border-[var(--mk-border)] rounded-[24px] [box-shadow:0_30px_80px_-20px_rgba(20,15,10,0.18),0_8px_24px_rgba(20,15,10,0.06)] overflow-hidden max-w-[1080px] mx-auto">
            ...
            <div className="flex items-center gap-2 px-[18px] py-[14px] border-b border-[var(--mk-border)] bg-[var(--mk-surface)]">
              ...
              <span className="ml-auto inline-flex items-center gap-2 bg-white border border-[var(--mk-border)] rounded-[999px] py-1 px-[10px] pl-1 text-xs font-medium text-[var(--mk-text)]">
                <span className="w-[22px] h-[22px] rounded-[999px] bg-[#98c97e] text-white inline-flex items-center justify-center text-[10.5px] font-bold">
                  M
                </span>
                Mboa
            ...
            <div className="grid [grid-template-columns:240px_1fr] min-h-[620px] max-[768px]:[grid-template-columns:1fr]">
              ...
              <aside className="bg-[#fafafa] border-r border-[var(--mk-border)] p-[14px_12px] flex flex-col gap-0.5 max-[768px]:hidden">
                ...
                {[
                  ...
                  <div
                    key={label}
                    className="flex items-center gap-[10px] px-[10px] py-2 rounded-lg text-[13px] text-[var(--mk-text)]"
                  >
                ...
                <div className="text-[10.5px] font-semibold tracking-[0.14em] uppercase text-[var(--mk-text-soft)] px-2 pt-3 pb-1">
                  Messageries
                </div>
                <div className="flex items-center gap-[10px] px-[10px] py-2 rounded-lg text-[13px] text-[var(--mk-text)] bg-white border border-[var(--mk-border)] [box-shadow:0_1px_2px_rgba(0,0,0,0.03)] font-bold">
                  <span className="w-[18px] h-[18px] inline-flex items-center justify-center">
                    <span
                      className="w-[9px] h-[9px] rounded-[999px] inline-block"
                      style={{ background: BRAND_WHATSAPP }}
                    />
                  </span>
                  WhatsApp
                  <span className="ml-auto text-[11px] bg-[var(--mk-text)] text-white py-[2px] px-[7px] rounded-[999px] font-semibold">
                    2
                  </span>
                </div>
                {[
              ...
              <div className="grid [grid-template-columns:280px_1fr] min-h-full max-[768px]:[grid-template-columns:1fr]">
                ...
                <div className="border-r border-[var(--mk-border)] bg-white max-[768px]:hidden">
                  <div className="px-[18px] py-[18px] pb-[14px] border-b border-[var(--mk-border)] flex flex-col gap-3">
                    <div className="flex items-center gap-1.5">
                      <span className="text-[11.5px] font-medium px-[11px] py-[5px] rounded-[999px] border border-[var(--mk-border)] text-[var(--mk-text)] bg-[var(--mk-text)] text-white border-[var(--mk-text)]">
                        All
                      </span>
                      <span className="text-[11.5px] font-medium px-[11px] py-[5px] rounded-[999px] border border-[var(--mk-border)] text-[var(--mk-text)] bg-white">
                        Unread
                      </span>
                      <span className="text-[11.5px] font-medium px-[11px] py-[5px] rounded-[999px] border border-[var(--mk-border)] text-[var(--mk-text)] bg-white">
                        Labels
                  ...
                  {[
                    {
                      ...
                      name: 'Laure Epoupa',
                      time: '20/04',
                      preview: 'Merci. Dans quelle ville souhaitez-vous être livrée ?',
                      active: true,
                    },
                    {
                      anim: 'left',
                      ...
                      name: 'Aisha Mbala',
                      time: '20/04',
                      preview: 'La livraison à Douala est offerte dès 25 000 FCFA.',
                      active: false,
                    },
                    {
                      anim: 'left',
                      ...
                      name: 'Jean-Paul Nkoa',
                      time: '19/04',
                      preview: 'Je vérifie le stock pour vous, deux minutes.',
                      active: false,
                    },
                    {
                      anim: 'left',
                      ...
                      name: 'Fatou Y.',
                      time: '18/04',
                      preview: "Merci beaucoup, c'est bien noté pour vendredi.",
                      active: false,
                    },
                  ].map((c) => (
                    <div
                    ...
                    >
                      <div
                        className="w-9 h-9 rounded-[999px] text-white inline-flex items-center justify-center font-semibold text-[13.5px] flex-shrink-0"
                        style={{ background: c.avBg }}
                      >
                        {c.letter}
                      </div>
                      <div className="min-w-0 w-full">
                        <div className="flex items-center justify-between gap-2">
                          ...
                          <span className="text-[11.5px] text-[var(--mk-text-soft)] font-medium flex-shrink-0">
                            {c.time}
                          </span>
                        </div>
                        <div className="text-[12.5px] text-[var(--mk-text-muted)] mt-1 whitespace-nowrap overflow-hidden text-ellipsis">
                          {c.preview}
                        </div>
                      </div>
                    </div>
                ...
                <div className="bg-white flex flex-col">
                  <div
                    className="px-[22px] py-4 border-b border-[var(--mk-border)] bg-white flex items-center gap-3"
                    data-anim="fade"
                    style={{ ['--mk-d' as string]: '120ms' }}
                  >
                    <div className="w-9 h-9 rounded-[999px] bg-[#98c97e] text-white inline-flex items-center justify-center font-semibold text-[13.5px] flex-shrink-0">
                      L
                    </div>
                    <div>
                      <div className="text-[14.5px] font-semibold">Laure Epoupa</div>
                      <div className="text-xs text-[var(--mk-text-soft)] mt-0.5">
                        +237 695 33 33 33
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="px-7 py-[22px] flex flex-col gap-[10px] flex-1 bg-white">
                    <span
                      className="self-center text-[11.5px] text-[var(--mk-text-muted)] bg-[#f5f5f5] px-3 py-[5px] rounded-[999px] my-1 mb-2 font-medium"
                      data-anim="fade"
                    ...
                    <div
                      className="max-w-[78%] px-[14px] pt-[11px] pb-2 rounded-2xl text-[13.5px] leading-[1.45] bg-white border border-[var(--mk-border)] rounded-bl-[6px] self-start pt-[6px]"
                      data-anim="left"
                      style={{ ['--mk-d' as string]: '500ms' }}
                    >
                      <div
                        className="w-[200px] h-[150px] rounded-[10px] bg-cover bg-center bg-[#e5e5e5] mb-2"
                        style={{
                          backgroundImage:
                    ...
                    <div
                      className="max-w-[78%] px-[14px] pt-[11px] pb-2 rounded-2xl text-[13.5px] leading-[1.45] bg-[#f5f5f5] text-[var(--mk-text)] rounded-br-[6px] self-end"
                      data-anim="right"
                    ...
                    <div
                      className="max-w-[78%] px-[14px] pt-[11px] pb-2 rounded-2xl text-[13.5px] leading-[1.45] bg-white border border-[var(--mk-border)] rounded-bl-[6px] self-start"
                      data-anim="left"
        ...
        <div className="mk-platforms-row mt-14 py-7 border-t border-b border-[var(--mk-border)]">
          <div className="flex items-center justify-between gap-6 flex-wrap">
            <span
              className="text-xs font-semibold tracking-[0.16em] uppercase text-[var(--mk-text-soft)]"
              data-anim="fade"
            >
                    ...
                    style={
                      gradient
                        ...
                        : msGradient
                          ? {
                              background:
                                'radial-gradient(circle at 30% 110%, #00b2ff 0%, #006aff 40%, #a033ff 100%)',
                            }
                          : { background: bg }
                    }
                  >
